        ...
        <div className={styles.Main}>
          ...
          <div className={styles.ItemInfo}>
            ...
            <div className={styles.ButtonBox}>
              ...
              <p className={styles.itemNumber}>&nbsp;{addItem}&nbsp;</p>{" "}
            ...
            <button className={styles.CartButton} onClick={addItemButton}>
              Add to Cart!
            </button>
            ...
            <p>
              ...
              quisquam quo distinctio doloremque mollitia aspernatur atque
              eveniet, obcaecati provident consectetur a blanditiis quidem in,
              nemo similique sequi, debitis quia cumque!
            </p>
            <p className={styles.Stock}>Number in stock: {item.quantity}</p>
            <span className={styles.Favourite}>
              <p className={styles.FavText}>Add to favourites</p>{" "}
              <img
